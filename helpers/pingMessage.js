function get(ping, context) {
    let messagesList = [
        ...
        "BEHOLD! THE POWER OF A",
        "i'm not fueled on blood, don't worry",
        "are you sure it's not just a strawberry with spray paint?",
        "flint and iron! wait, no",
        ...
        context.user ? `${context.user.username.toUpperCase()} IS YOU` : "EMPTY IS YOU",
        "somewhere, it's raining cats",
        "shouldn't have gone to med school",
        "WHY IS THE RAIN HERE ALREADY",
